 <?php 
 function ws_include_referrers($current,$referr_stats)
        {
?> 
    <div class="data_boxes">
        <div class="data_boxes_title"><?php echo _e( 'Top Referrers', 'wp-WSAnalytics'); ?><div class="arrow_btn"></div></div>
                    ...
                    <?php foreach ($referr_stats["rows"] as $r_stats): ?>
                            <div class="stats">
                                <div class="row-visits">
                                    <span class="large-count"><?php echo $current->wws_number_format( $r_stats[2] ); ?> </span>
                                    <?php echo _e( 'Visits' , 'wp-WSAnalytics'); ?>
                                </div>
  ...
  <div class="data_boxes_footer">
        ...
        <span class="information-txt"><?php echo _e('who are the strong Referrers to your site ?? See above.', 'wp-WSAnalytics'); ?></span>
  </div>
</div>
<?php } ?>