...
<div class="data_boxes">
  ...
  <div class="data_container">
      ...
      <div class="grids_auto_size">
        ...
        <div class="grid_data cen">
            <div class="data_value">
                ...
                <div class="grid_footer cen"> <?php echo _e('The amount of time someone spends on your site.' , 'wp-WSAnalytics')?> </div>
    </div>
        <div class="grids_auto_size">
            <div class="grid_title"> <?php echo _e('AVERAGE PAGES' , 'wp-WSAnalytics')?> </div>
                <div class="grid_data cen">
                    <div class="data_value">
                        <?php
                          if ($stats->totalsForAllResults['ga:sessions'] <= 0) {
                      ...
                      <div class="grid_footer cen">
                            <?php echo _e('Pages/Session is the average number of pages viewed during a session. Repeated views of a single page are counted.', 'wp-WSAnalytics')?>
                      </div>
        </div>
     <div class="grids_auto_size">
    ...
    <div class="grids_auto_size">
        <div class="grid_title">
            <?php echo _e(' % NEW SESSIONS', 'wp-WSAnalytics')?>
        </div>
        <div class="grid_data cen">
            <div class="data_value">
                <?php
    ...
    <div class="grids_auto_size">
        ...
        <div class="grid_data cen">
            <div class="data_value">
                ...
                <div id="visitorschart" style="width: 99%; height: 122px; border-radius: 50%;overflow: hidden;"></div>
    ...
    <div class="data_boxes_footer">
                ...
                <span class="information-txt">
                  <?php echo _e('Did you know that total time on your site is' , 'wp-WSAnalytics')?>
                  <?php
