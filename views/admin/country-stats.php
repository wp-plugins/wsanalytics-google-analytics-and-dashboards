...
function ws_include_country( $current, $country_stats ) {
?>
<div class="data_boxes">
    <div class="data_boxes_title"><?php echo _e( 'Top Countries', 'wp-WSAnalytics'); ?> <div class="arrow_btn"></div></div>
                ...
                <?php foreach ( $country_stats["rows"] as $c_stats ){ ?>
                        <div class="stats">
                            <div class="row-visits">
                                <span class="large-count"><?php echo $current->wws_number_format( $c_stats[1] ) ; ?></span>
                            Visits
                            </div>
