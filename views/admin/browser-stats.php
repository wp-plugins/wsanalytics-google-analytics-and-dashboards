...
function ws_include_browser( $current, $browser_stats ) {
?>
<div class="data_boxes">
  <div class="data_boxes_title"><?php echo _e( 'Browsers Statistics', 'wp-WSAnalytics'); ?><div class="arrow_btn"></div></div>
  ...
  <div class="data_boxes_footer">
      ...
      <span class="information-txt"><?php echo _e('listing statistics of top five browsers.', 'wp-WSAnalytics');?></span>
  </div>
</div>
<?php } ?>