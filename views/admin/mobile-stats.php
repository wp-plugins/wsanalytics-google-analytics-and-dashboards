<?php 
// 
function ws_include_mobile( $current, $mobile_stats ) {

?>
<div class="data_boxes">
    <div class="data_boxes_title "><?php echo _e( 'Mobile Devices Statistics', 'wp-WSAnalytics'); ?> <div class="arrow_btn"></div></div>
                ...
                <?php foreach ($mobile_stats["rows"] as $m_stats){ ?>
                        <div class="stats">
                            <div class="row-visits">
                                <span class="large-count"><?php echo $current->wws_number_format( $m_stats[1] ); ?></span>
                            Visits
                            </div>
