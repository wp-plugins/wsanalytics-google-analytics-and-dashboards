...
function ws_include_operating( $current, $operating_stats ) {
?>
<div class="data_boxes">
    <div class="data_boxes_title "><?php echo _e( 'Operating System Statistics', 'wp-WSAnalytics'); ?> <div class="arrow_btn"></div></div>
                ...
                <?php foreach ($operating_stats["rows"] as $op_stats){ ?>
                        <div class="stats">
                            <div class="row-visits">
                                <span class="large-count"><?php echo $current->wws_number_format( $op_stats[2] ); ?></span>
                            Visits
                            </div>
