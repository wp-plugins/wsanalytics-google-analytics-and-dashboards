 ...
 * @author Google, Inc.
 */
class WSAnalytics_Google_Service_Appsactivity extends WSAnalytics_Google_Service
{
  ...
  public function __construct(WSAnalytics_Google_Client $client)
  {
    ...
    $this->activities = new WSAnalytics_Google_Service_Appsactivity_Activities_Resource(
        $this,
        $this->serviceName,
        'activities',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $appsactivityService = new WSAnalytics_Google_Service_Appsactivity(...);
 *   $activities = $appsactivityService->activities;
 *  </code>
 */
class WSAnalytics_Google_Service_Appsactivity_Activities_Resource extends WSAnalytics_Google_Service_Resource
{
  ...
  -
    * drive.google.com
   * @return WSAnalytics_Google_Service_Appsactivity_ListActivitiesResponse
   */
  public function listActivities($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WSAnalytics_Google_Service_Appsactivity_ListActivitiesResponse");
  }
}
...
class WSAnalytics_Google_Service_Appsactivity_Activity extends WSAnalytics_Google_Collection
{
  protected $combinedEventType = 'WSAnalytics_Google_Service_Appsactivity_Event';
  protected $combinedEventDataType = '';
  protected $singleEventsType = 'WSAnalytics_Google_Service_Appsactivity_Event';
  protected $singleEventsDataType = 'array';

  public function setCombinedEvent(WSAnalytics_Google_Service_Appsactivity_Event $combinedEvent)
  {
...
class WSAnalytics_Google_Service_Appsactivity_Event extends WSAnalytics_Google_Collection
{
  public $additionalEventTypes;
  public $eventTimeMillis;
  public $fromUserDeletion;
  protected $moveType = 'WSAnalytics_Google_Service_Appsactivity_Move';
  protected $moveDataType = '';
  protected $permissionChangesType = 'WSAnalytics_Google_Service_Appsactivity_PermissionChange';
  protected $permissionChangesDataType = 'array';
  public $primaryEventType;
  protected $renameType = 'WSAnalytics_Google_Service_Appsactivity_Rename';
  protected $renameDataType = '';
  protected $targetType = 'WSAnalytics_Google_Service_Appsactivity_Target';
  protected $targetDataType = '';
  protected $userType = 'WSAnalytics_Google_Service_Appsactivity_User';
  ...
  public function setMove(WSAnalytics_Google_Service_Appsactivity_Move $move)
  {
    $this->move = $move;
  }
  ...
  public function setRename(WSAnalytics_Google_Service_Appsactivity_Rename $rename)
  {
    $this->rename = $rename;
  }
  ...
  public function setTarget(WSAnalytics_Google_Service_Appsactivity_Target $target)
  {
    $this->target = $target;
  }
  ...
  public function setUser(WSAnalytics_Google_Service_Appsactivity_User $user)
  {
    $this->user = $user;
  }
...
class WSAnalytics_Google_Service_Appsactivity_ListActivitiesResponse extends WSAnalytics_Google_Collection
{
  protected $activitiesType = 'WSAnalytics_Google_Service_Appsactivity_Activity';
...
class WSAnalytics_Google_Service_Appsactivity_Move extends WSAnalytics_Google_Collection
{
  protected $addedParentsType = 'WSAnalytics_Google_Service_Appsactivity_Parent';
  protected $addedParentsDataType = 'array';
  protected $removedParentsType = 'WSAnalytics_Google_Service_Appsactivity_Parent';
...
class WSAnalytics_Google_Service_Appsactivity_Parent extends WSAnalytics_Google_Model
{
  public $id;
  public $isRoot;
  public $title;
...
class WSAnalytics_Google_Service_Appsactivity_Permission extends WSAnalytics_Google_Model
{
  public $name;
  public $permissionId;
  public $role;
...
class WSAnalytics_Google_Service_Appsactivity_PermissionChange extends WSAnalytics_Google_Collection
{
  protected $addedPermissionsType = 'WSAnalytics_Google_Service_Appsactivity_Permission';
  protected $addedPermissionsDataType = 'array';
  protected $removedPermissionsType = 'WSAnalytics_Google_Service_Appsactivity_Permission';
...
class WSAnalytics_Google_Service_Appsactivity_Photo extends WSAnalytics_Google_Model
{
  public $url;
...
class WSAnalytics_Google_Service_Appsactivity_Rename extends WSAnalytics_Google_Model
{
  public $newTitle;
  public $oldTitle;
...
class WSAnalytics_Google_Service_Appsactivity_Target extends WSAnalytics_Google_Model
{
  public $id;
  public $mimeType;
  public $name;
...
class WSAnalytics_Google_Service_Appsactivity_User extends WSAnalytics_Google_Model
{
  public $name;
  protected $photoType = 'WSAnalytics_Google_Service_Appsactivity_Photo';
  ...
  public function setPhoto(WSAnalytics_Google_Service_Appsactivity_Photo $photo)
  {
    $this->photo = $photo;
  }
