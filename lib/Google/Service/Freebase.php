 ...
 * @author Google, Inc.
 */
class WSAnalytics_Google_Service_Freebase extends WSAnalytics_Google_Service
{
  ...
  public function __construct(WSAnalytics_Google_Client $client)
  {
    ...
    $this->base_methods = new WSAnalytics_Google_Service_Resource(
        $this,
        $this->serviceName,
        '',
        array(
   ...
   * @return WSAnalytics_Google_Service_Freebase_ReconcileGet
   */
  public function reconcile($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->base_methods->call('reconcile', array($params), "WSAnalytics_Google_Service_Freebase_ReconcileGet");
  }
  /**
...
class WSAnalytics_Google_Service_Freebase_ReconcileCandidate extends WSAnalytics_Google_Model
{
  public $confidence;
  public $lang;
  public $mid;
  public $name;
  protected $notableType = 'WSAnalytics_Google_Service_Freebase_ReconcileCandidateNotable';
  ...
  public function setNotable(WSAnalytics_Google_Service_Freebase_ReconcileCandidateNotable $notable)
  {
...
class WSAnalytics_Google_Service_Freebase_ReconcileCandidateNotable extends WSAnalytics_Google_Model
{
  public $id;
  public $name;
...
class WSAnalytics_Google_Service_Freebase_ReconcileGet extends WSAnalytics_Google_Collection
{
  protected $candidateType = 'WSAnalytics_Google_Service_Freebase_ReconcileCandidate';
  protected $candidateDataType = 'array';
  protected $costsType = 'WSAnalytics_Google_Service_Freebase_ReconcileGetCosts';
  protected $costsDataType = '';
  protected $matchType = 'WSAnalytics_Google_Service_Freebase_ReconcileCandidate';
  protected $matchDataType = '';
  protected $warningType = 'WSAnalytics_Google_Service_Freebase_ReconcileGetWarning';
  ...
  public function setCosts(WSAnalytics_Google_Service_Freebase_ReconcileGetCosts $costs)
  {
    $this->costs = $costs;
  }
  ...
  public function setMatch(WSAnalytics_Google_Service_Freebase_ReconcileCandidate $match)
  {
    $this->match = $match;
  }
...
class WSAnalytics_Google_Service_Freebase_ReconcileGetCosts extends WSAnalytics_Google_Model
{
  public $hits;
  public $ms;
...
class WSAnalytics_Google_Service_Freebase_ReconcileGetWarning extends WSAnalytics_Google_Model
{
  public $location;
  public $message;
  public $reason;
