 ...
 * @author Google, Inc.
 */
class WSAnalytics_Google_Service_YouTubeAnalytics extends WSAnalytics_Google_Service
{
  ...
  public function __construct(WSAnalytics_Google_Client $client)
  {
    ...
    $this->batchReportDefinitions = new WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportDefinitions_Resource(
        $this,
        $this->serviceName,
    ...
    $this->batchReports = new WSAnalytics_Google_Service_YouTubeAnalytics_BatchReports_Resource(
        $this,
        $this->serviceName,
        'batchReports',
        array(
    ...
    $this->reports = new WSAnalytics_Google_Service_YouTubeAnalytics_Reports_Resource(
        $this,
        $this->serviceName,
        'reports',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $youtubeAnalyticsService = new WSAnalytics_Google_Service_YouTubeAnalytics(...);
 *   $batchReportDefinitions = $youtubeAnalyticsService->batchReportDefinitions;
 *  </code>
 */
class WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportDefinitions_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * @return WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportDefinitionList
   */
  public function listBatchReportDefinitions($onBehalfOfContentOwner, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportDefinitionList");
  }
}
 ...
 *  </code>
 */
class WSAnalytics_Google_Service_YouTubeAnalytics_BatchReports_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * The onBehalfOfContentOwner parameter identifies the content owner that the user is acting on
    * behalf of.
   * @param array $optParams Optional parameters.
   * @return WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportList
   */
  public function listBatchReports($batchReportDefinitionId, $onBehalfOfContentOwner, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportList");
  }
}
 ...
 *  </code>
 */
class WSAnalytics_Google_Service_YouTubeAnalytics_Reports_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * @return WSAnalytics_Google_Service_YouTubeAnalytics_ResultTable
   */
  public function query($ids, $startDate, $endDate, $metrics, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "WSAnalytics_Google_Service_YouTubeAnalytics_ResultTable");
  }
}
...
class WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportDefinitionList extends WSAnalytics_Google_Collection
{
  protected $itemsType = 'WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportDefinitionTemplate';
...
class WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportDefinitionTemplate extends WSAnalytics_Google_Collection
{
  protected $defaultOutputType = 'WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportDefinitionTemplateDefaultOutput';
...
class WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportDefinitionTemplateDefaultOutput extends WSAnalytics_Google_Model
{
  public $format;
  public $type;
...
class WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportList extends WSAnalytics_Google_Collection
{
  protected $itemsType = 'WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportTemplate';
  protected $itemsDataType = 'array';
  public $kind;
...
class WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportTemplate extends WSAnalytics_Google_Collection
{
  public $id;
  protected $outputsType = 'WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportTemplateOutputs';
  protected $outputsDataType = 'array';
  public $reportId;
  protected $timeSpanType = 'WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportTemplateTimeSpan';
  ...
  public function setTimeSpan(WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportTemplateTimeSpan $timeSpan)
  {
...
class WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportTemplateOutputs extends WSAnalytics_Google_Model
{
  public $downloadUrl;
  public $format;
  public $type;
...
class WSAnalytics_Google_Service_YouTubeAnalytics_BatchReportTemplateTimeSpan extends WSAnalytics_Google_Model
{
  public $endTime;
  public $startTime;
...
class WSAnalytics_Google_Service_YouTubeAnalytics_ResultTable extends WSAnalytics_Google_Collection
{
  protected $columnHeadersType = 'WSAnalytics_Google_Service_YouTubeAnalytics_ResultTableColumnHeaders';
...
class WSAnalytics_Google_Service_YouTubeAnalytics_ResultTableColumnHeaders extends WSAnalytics_Google_Model
{
  public $columnType;
  public $dataType;
  public $name;
