 ...
 * @author Google, Inc.
 */
class WSAnalytics_Google_Service_Dns extends WSAnalytics_Google_Service
{
  ...
  public function __construct(WSAnalytics_Google_Client $client)
  {
    ...
    $this->changes = new WSAnalytics_Google_Service_Dns_Changes_Resource(
        $this,
        $this->serviceName,
        'changes',
        array(
    ...
    $this->managedZones = new WSAnalytics_Google_Service_Dns_ManagedZones_Resource(
        $this,
        $this->serviceName,
        'managedZones',
        array(
    ...
    $this->projects = new WSAnalytics_Google_Service_Dns_Projects_Resource(
        $this,
        $this->serviceName,
        'projects',
        array(
    ...
    $this->resourceRecordSets = new WSAnalytics_Google_Service_Dns_ResourceRecordSets_Resource(
        $this,
        $this->serviceName,
        'resourceRecordSets',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $dnsService = new WSAnalytics_Google_Service_Dns(...);
 *   $changes = $dnsService->changes;
 *  </code>
 */
class WSAnalytics_Google_Service_Dns_Changes_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * @param WSAnalytics_Google_Change $postBody
   * @param array $optParams Optional parameters.
   * @return WSAnalytics_Google_Service_Dns_Change
   */
  public function create($project, $managedZone, WSAnalytics_Google_Service_Dns_Change $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "WSAnalytics_Google_Service_Dns_Change");
  }
  /**
  ...
  public function get($project, $managedZone, $changeId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WSAnalytics_Google_Service_Dns_Change");
  }
  /**
   ...
   * @return WSAnalytics_Google_Service_Dns_ChangesListResponse
   */
  public function listChanges($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WSAnalytics_Google_Service_Dns_ChangesListResponse");
  }
}
 ...
 *  </code>
 */
class WSAnalytics_Google_Service_Dns_ManagedZones_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * @param string $project
   * Identifies the project addressed by this request.
   * @param WSAnalytics_Google_ManagedZone $postBody
   * @param array $optParams Optional parameters.
   * @return WSAnalytics_Google_Service_Dns_ManagedZone
   */
  public function create($project, WSAnalytics_Google_Service_Dns_ManagedZone $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "WSAnalytics_Google_Service_Dns_ManagedZone");
  }
  /**
  ...
  public function get($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WSAnalytics_Google_Service_Dns_ManagedZone");
  }
  /**
   ...
   * Optional. Maximum number of results to be returned. If unspecified, the server will decide how
    * many results to return.
   * @return WSAnalytics_Google_Service_Dns_ManagedZonesListResponse
   */
  public function listManagedZones($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WSAnalytics_Google_Service_Dns_ManagedZonesListResponse");
  }
}
 ...
 *  </code>
 */
class WSAnalytics_Google_Service_Dns_Projects_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * Identifies the project addressed by this request.
   * @param array $optParams Optional parameters.
   * @return WSAnalytics_Google_Service_Dns_Project
   */
  public function get($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WSAnalytics_Google_Service_Dns_Project");
  }
}
 ...
 *  </code>
 */
class WSAnalytics_Google_Service_Dns_ResourceRecordSets_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * Restricts the list to return only records of this type. If present, the "name" parameter must
    * also be present.
   * @return WSAnalytics_Google_Service_Dns_ResourceRecordSetsListResponse
   */
  public function listResourceRecordSets($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WSAnalytics_Google_Service_Dns_ResourceRecordSetsListResponse");
  }
}
...
class WSAnalytics_Google_Service_Dns_Change extends WSAnalytics_Google_Collection
{
  protected $additionsType = 'WSAnalytics_Google_Service_Dns_ResourceRecordSet';
  protected $additionsDataType = 'array';
  protected $deletionsType = 'WSAnalytics_Google_Service_Dns_ResourceRecordSet';
...
class WSAnalytics_Google_Service_Dns_ChangesListResponse extends WSAnalytics_Google_Collection
{
  protected $changesType = 'WSAnalytics_Google_Service_Dns_Change';
...
class WSAnalytics_Google_Service_Dns_ManagedZone extends WSAnalytics_Google_Collection
{
  public $creationTime;
  public $description;
  public $dnsName;
...
class WSAnalytics_Google_Service_Dns_ManagedZonesListResponse extends WSAnalytics_Google_Collection
{
  public $kind;
  protected $managedZonesType = 'WSAnalytics_Google_Service_Dns_ManagedZone';
...
class WSAnalytics_Google_Service_Dns_Project extends WSAnalytics_Google_Model
{
  public $id;
  public $kind;
  public $number;
  protected $quotaType = 'WSAnalytics_Google_Service_Dns_Quota';
  ...
  public function setQuota(WSAnalytics_Google_Service_Dns_Quota $quota)
  {
    $this->quota = $quota;
  }
...
class WSAnalytics_Google_Service_Dns_Quota extends WSAnalytics_Google_Model
{
  public $kind;
  public $managedZones;
...
class WSAnalytics_Google_Service_Dns_ResourceRecordSet extends WSAnalytics_Google_Collection
{
  public $kind;
  public $name;
  public $rrdatas;
...
class WSAnalytics_Google_Service_Dns_ResourceRecordSetsListResponse extends WSAnalytics_Google_Collection
{
  public $kind;
  public $nextPageToken;
  protected $rrsetsType = 'WSAnalytics_Google_Service_Dns_ResourceRecordSet';
