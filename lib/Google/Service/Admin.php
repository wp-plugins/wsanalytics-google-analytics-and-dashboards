 ...
 * @author Google, Inc.
 */
class WSAnalytics_Google_Service_Admin extends WSAnalytics_Google_Service
{
  ...
  public function __construct(WSAnalytics_Google_Client $client)
  {
    ...
    $this->mail = new WSAnalytics_Google_Service_Admin_Mail_Resource(
        $this,
        $this->serviceName,
        'mail',
        array(
...
class WSAnalytics_Google_Service_Admin_Mail_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * @param WSAnalytics_Google_MailItem $postBody
   * @param array $optParams Optional parameters.
   */
  public function insert($userKey, WSAnalytics_Google_Service_Admin_MailItem $postBody, $optParams = array())
  {
...
class WSAnalytics_Google_Service_Admin_MailItem extends WSAnalytics_Google_Collection
{
  public $isDeleted;
  public $isDraft;
  public $isInbox;
