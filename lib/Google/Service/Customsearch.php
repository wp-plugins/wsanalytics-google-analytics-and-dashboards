 ...
 * @author Google, Inc.
 */
class WSAnalytics_Google_Service_Customsearch extends WSAnalytics_Google_Service
{
  ...
  public function __construct(WSAnalytics_Google_Client $client)
  {
    ...
    $this->cse = new WSAnalytics_Google_Service_Customsearch_Cse_Resource(
        $this,
        $this->serviceName,
        'cse',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $customsearchService = new WSAnalytics_Google_Service_Customsearch(...);
 *   $cse = $customsearchService->cse;
 *  </code>
 */
class WSAnalytics_Google_Service_Customsearch_Cse_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * Controls whether to include or exclude results from the site named in the as_sitesearch
    * parameter
   * @return WSAnalytics_Google_Service_Customsearch_Search
   */
  public function listCse($q, $optParams = array())
  {
    $params = array('q' => $q);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WSAnalytics_Google_Service_Customsearch_Search");
  }
}
...
class WSAnalytics_Google_Service_Customsearch_Context extends WSAnalytics_Google_Collection
{
  protected $facetsType = 'WSAnalytics_Google_Service_Customsearch_ContextFacets';
...
class WSAnalytics_Google_Service_Customsearch_ContextFacets extends WSAnalytics_Google_Model
{
  public $anchor;
  public $label;
  public $labelWithOp;
...
class WSAnalytics_Google_Service_Customsearch_Promotion extends WSAnalytics_Google_Collection
{
  protected $bodyLinesType = 'WSAnalytics_Google_Service_Customsearch_PromotionBodyLines';
  protected $bodyLinesDataType = 'array';
  public $displayLink;
  public $htmlTitle;
  protected $imageType = 'WSAnalytics_Google_Service_Customsearch_PromotionImage';
  ...
  public function setImage(WSAnalytics_Google_Service_Customsearch_PromotionImage $image)
  {
    $this->image = $image;
  }
...
class WSAnalytics_Google_Service_Customsearch_PromotionBodyLines extends WSAnalytics_Google_Model
{
  public $htmlTitle;
  public $link;
  public $title;
...
class WSAnalytics_Google_Service_Customsearch_PromotionImage extends WSAnalytics_Google_Model
{
  public $height;
  public $source;
  public $width;
...
class WSAnalytics_Google_Service_Customsearch_Query extends WSAnalytics_Google_Model
{
  public $count;
  public $cr;
  public $cref;
...
class WSAnalytics_Google_Service_Customsearch_Result extends WSAnalytics_Google_Collection
{
  public $cacheId;
  public $displayLink;
  public $fileFormat;
  ...
  public $htmlSnippet;
  public $htmlTitle;
  protected $imageType = 'WSAnalytics_Google_Service_Customsearch_ResultImage';
  protected $imageDataType = '';
  public $kind;
  protected $labelsType = 'WSAnalytics_Google_Service_Customsearch_ResultLabels';
  ...
  public function setImage(WSAnalytics_Google_Service_Customsearch_ResultImage $image)
  {
    $this->image = $image;
  }
...
class WSAnalytics_Google_Service_Customsearch_ResultImage extends WSAnalytics_Google_Model
{
  public $byteSize;
  public $contextLink;
  public $height;
...
class WSAnalytics_Google_Service_Customsearch_ResultLabels extends WSAnalytics_Google_Model
{
  public $displayName;
  public $labelWithOp;
  public $name;
...
class WSAnalytics_Google_Service_Customsearch_ResultPagemap extends WSAnalytics_Google_Model
{

}

class WSAnalytics_Google_Service_Customsearch_ResultPagemapItemElement extends WSAnalytics_Google_Model
{

}

class WSAnalytics_Google_Service_Customsearch_Search extends WSAnalytics_Google_Collection
{
  protected $contextType = 'WSAnalytics_Google_Service_Customsearch_Context';
  protected $contextDataType = '';
  protected $itemsType = 'WSAnalytics_Google_Service_Customsearch_Result';
  protected $itemsDataType = 'array';
  public $kind;
  protected $promotionsType = 'WSAnalytics_Google_Service_Customsearch_Promotion';
  protected $promotionsDataType = 'array';
  protected $queriesType = 'WSAnalytics_Google_Service_Customsearch_Query';
  protected $queriesDataType = 'map';
  protected $searchInformationType = 'WSAnalytics_Google_Service_Customsearch_SearchSearchInformation';
  protected $searchInformationDataType = '';
  protected $spellingType = 'WSAnalytics_Google_Service_Customsearch_SearchSpelling';
  protected $spellingDataType = '';
  protected $urlType = 'WSAnalytics_Google_Service_Customsearch_SearchUrl';
  protected $urlDataType = '';

  public function setContext(WSAnalytics_Google_Service_Customsearch_Context $context)
  {
  ...
  public function setSearchInformation(WSAnalytics_Google_Service_Customsearch_SearchSearchInformation $searchInformation)
  {
  ...
  public function setSpelling(WSAnalytics_Google_Service_Customsearch_SearchSpelling $spelling)
  {
  ...
  public function setUrl(WSAnalytics_Google_Service_Customsearch_SearchUrl $url)
  {
    $this->url = $url;
  }
...
class WSAnalytics_Google_Service_Customsearch_SearchQueries extends WSAnalytics_Google_Model
{

}

class WSAnalytics_Google_Service_Customsearch_SearchSearchInformation extends WSAnalytics_Google_Model
{
...
class WSAnalytics_Google_Service_Customsearch_SearchSpelling extends WSAnalytics_Google_Model
{
...
class WSAnalytics_Google_Service_Customsearch_SearchUrl extends WSAnalytics_Google_Model
{
  public $template;
  public $type;
