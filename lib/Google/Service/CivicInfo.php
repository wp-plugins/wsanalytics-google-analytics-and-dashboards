 ...
 * @author Google, Inc.
 */
class WSAnalytics_Google_Service_CivicInfo extends WSAnalytics_Google_Service
{
  ...
  public function __construct(WSAnalytics_Google_Client $client)
  {
    ...
    $this->divisions = new WSAnalytics_Google_Service_CivicInfo_Divisions_Resource(
        $this,
        $this->serviceName,
        'divisions',
        array(
    ...
    $this->elections = new WSAnalytics_Google_Service_CivicInfo_Elections_Resource(
        $this,
        $this->serviceName,
        'elections',
        array(
    ...
    $this->representatives = new WSAnalytics_Google_Service_CivicInfo_Representatives_Resource(
        $this,
        $this->serviceName,
        'representatives',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $civicinfoService = new WSAnalytics_Google_Service_CivicInfo(...);
 *   $divisions = $civicinfoService->divisions;
 *  </code>
 */
class WSAnalytics_Google_Service_CivicInfo_Divisions_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * @return WSAnalytics_Google_Service_CivicInfo_DivisionSearchResponse
   */
  public function search($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "WSAnalytics_Google_Service_CivicInfo_DivisionSearchResponse");
  }
}
 ...
 *  </code>
 */
class WSAnalytics_Google_Service_CivicInfo_Elections_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   *
   * @param array $optParams Optional parameters.
   * @return WSAnalytics_Google_Service_CivicInfo_ElectionsQueryResponse
   */
  public function electionQuery($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('electionQuery', array($params), "WSAnalytics_Google_Service_CivicInfo_ElectionsQueryResponse");
  }
  /**
   ...
   * @param WSAnalytics_Google_VoterInfoRequest $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param bool officialOnly
   * If set to true, only data from official state sources will be returned.
   * @return WSAnalytics_Google_Service_CivicInfo_VoterInfoResponse
   */
  public function voterInfoQuery($electionId, WSAnalytics_Google_Service_CivicInfo_VoterInfoRequest $postBody, $optParams = array())
  {
    $params = array('electionId' => $electionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('voterInfoQuery', array($params), "WSAnalytics_Google_Service_CivicInfo_VoterInfoResponse");
  }
}
 ...
 *  </code>
 */
class WSAnalytics_Google_Service_CivicInfo_Representatives_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   *
   * @param WSAnalytics_Google_RepresentativeInfoRequest $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return WSAnalytics_Google_Service_CivicInfo_RepresentativeInfoResponse
   */
  public function representativeInfoQuery(WSAnalytics_Google_Service_CivicInfo_RepresentativeInfoRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('representativeInfoQuery', array($params), "WSAnalytics_Google_Service_CivicInfo_RepresentativeInfoResponse");
  }
}
...
class WSAnalytics_Google_Service_CivicInfo_AdministrationRegion extends WSAnalytics_Google_Collection
{
  protected $electionAdministrationBodyType = 'WSAnalytics_Google_Service_CivicInfo_AdministrativeBody';
  protected $electionAdministrationBodyDataType = '';
  public $id;
  protected $localJurisdictionType = 'WSAnalytics_Google_Service_CivicInfo_AdministrationRegion';
  protected $localJurisdictionDataType = '';
  public $name;
  protected $sourcesType = 'WSAnalytics_Google_Service_CivicInfo_Source';
  protected $sourcesDataType = 'array';

  public function setElectionAdministrationBody(WSAnalytics_Google_Service_CivicInfo_AdministrativeBody $electionAdministrationBody)
  {
  ...
  public function setLocalJurisdiction(WSAnalytics_Google_Service_CivicInfo_AdministrationRegion $localJurisdiction)
  {
...
class WSAnalytics_Google_Service_CivicInfo_AdministrativeBody extends WSAnalytics_Google_Collection
{
  public $absenteeVotingInfoUrl;
  public $ballotInfoUrl;
  protected $correspondenceAddressType = 'WSAnalytics_Google_Service_CivicInfo_SimpleAddressType';
  protected $correspondenceAddressDataType = '';
  public $electionInfoUrl;
  protected $electionOfficialsType = 'WSAnalytics_Google_Service_CivicInfo_ElectionOfficial';
  ...
  public $name;
  protected $physicalAddressType = 'WSAnalytics_Google_Service_CivicInfo_SimpleAddressType';
  ...
  public function setCorrespondenceAddress(WSAnalytics_Google_Service_CivicInfo_SimpleAddressType $correspondenceAddress)
  {
  ...
  public function setPhysicalAddress(WSAnalytics_Google_Service_CivicInfo_SimpleAddressType $physicalAddress)
  {
...
class WSAnalytics_Google_Service_CivicInfo_Candidate extends WSAnalytics_Google_Collection
{
  public $candidateUrl;
  protected $channelsType = 'WSAnalytics_Google_Service_CivicInfo_Channel';
...
class WSAnalytics_Google_Service_CivicInfo_Channel extends WSAnalytics_Google_Model
{
  public $id;
  public $type;
...
class WSAnalytics_Google_Service_CivicInfo_Contest extends WSAnalytics_Google_Collection
{
  public $ballotPlacement;
  protected $candidatesType = 'WSAnalytics_Google_Service_CivicInfo_Candidate';
  protected $candidatesDataType = 'array';
  protected $districtType = 'WSAnalytics_Google_Service_CivicInfo_ElectoralDistrict';
  ...
  public function setDistrict(WSAnalytics_Google_Service_CivicInfo_ElectoralDistrict $district)
  {
...
class WSAnalytics_Google_Service_CivicInfo_DivisionSearchResponse extends WSAnalytics_Google_Collection
{
  public $kind;
  protected $resultsType = 'WSAnalytics_Google_Service_CivicInfo_DivisionSearchResult';
...
class WSAnalytics_Google_Service_CivicInfo_DivisionSearchResult extends WSAnalytics_Google_Collection
{
  public $aliases;
  public $name;
  public $ocdId;
...
class WSAnalytics_Google_Service_CivicInfo_Election extends WSAnalytics_Google_Model
{
  public $electionDay;
  public $id;
  public $name;
...
class WSAnalytics_Google_Service_CivicInfo_ElectionOfficial extends WSAnalytics_Google_Model
{
  public $emailAddress;
  public $faxNumber;
  public $name;
...
class WSAnalytics_Google_Service_CivicInfo_ElectionsQueryResponse extends WSAnalytics_Google_Collection
{
  protected $electionsType = 'WSAnalytics_Google_Service_CivicInfo_Election';
...
class WSAnalytics_Google_Service_CivicInfo_ElectoralDistrict extends WSAnalytics_Google_Model
{
  public $id;
  public $name;
  public $scope;
...
class WSAnalytics_Google_Service_CivicInfo_GeographicDivision extends WSAnalytics_Google_Collection
{
  public $alsoKnownAs;
  public $name;
  public $officeIds;
...
class WSAnalytics_Google_Service_CivicInfo_Office extends WSAnalytics_Google_Collection
{
  public $divisionId;
  public $level;
  public $name;
...
class WSAnalytics_Google_Service_CivicInfo_Official extends WSAnalytics_Google_Collection
{
  protected $addressType = 'WSAnalytics_Google_Service_CivicInfo_SimpleAddressType';
...
class WSAnalytics_Google_Service_CivicInfo_PollingLocation extends WSAnalytics_Google_Collection
{
  protected $addressType = 'WSAnalytics_Google_Service_CivicInfo_SimpleAddressType';
  ...
  public function setAddress(WSAnalytics_Google_Service_CivicInfo_SimpleAddressType $address)
  {
    $this->address = $address;
  }
...
class WSAnalytics_Google_Service_CivicInfo_RepresentativeInfoRequest extends WSAnalytics_Google_Model
{
  public $address;
...
class WSAnalytics_Google_Service_CivicInfo_RepresentativeInfoResponse extends WSAnalytics_Google_Model
{
  protected $divisionsType = 'WSAnalytics_Google_Service_CivicInfo_GeographicDivision';
  protected $divisionsDataType = 'map';
  public $kind;
  protected $normalizedInputType = 'WSAnalytics_Google_Service_CivicInfo_SimpleAddressType';
  protected $normalizedInputDataType = '';
  protected $officesType = 'WSAnalytics_Google_Service_CivicInfo_Office';
  protected $officesDataType = 'map';
  protected $officialsType = 'WSAnalytics_Google_Service_CivicInfo_Official';
  ...
  public function setNormalizedInput(WSAnalytics_Google_Service_CivicInfo_SimpleAddressType $normalizedInput)
  {
...
class WSAnalytics_Google_Service_CivicInfo_RepresentativeInfoResponseDivisions extends WSAnalytics_Google_Model
{

}

class WSAnalytics_Google_Service_CivicInfo_RepresentativeInfoResponseOffices extends WSAnalytics_Google_Model
{

}

class WSAnalytics_Google_Service_CivicInfo_RepresentativeInfoResponseOfficials extends WSAnalytics_Google_Model
{

}

class WSAnalytics_Google_Service_CivicInfo_SimpleAddressType extends WSAnalytics_Google_Model
{
  public $city;
  public $line1;
  public $line2;
...
class WSAnalytics_Google_Service_CivicInfo_Source extends WSAnalytics_Google_Model
{
  public $name;
  public $official;
...
class WSAnalytics_Google_Service_CivicInfo_VoterInfoRequest extends WSAnalytics_Google_Model
{
  public $address;
...
class WSAnalytics_Google_Service_CivicInfo_VoterInfoResponse extends WSAnalytics_Google_Collection
{
  protected $contestsType = 'WSAnalytics_Google_Service_CivicInfo_Contest';
  protected $contestsDataType = 'array';
  protected $earlyVoteSitesType = 'WSAnalytics_Google_Service_CivicInfo_PollingLocation';
  protected $earlyVoteSitesDataType = 'array';
  protected $electionType = 'WSAnalytics_Google_Service_CivicInfo_Election';
  protected $electionDataType = '';
  public $kind;
  protected $normalizedInputType = 'WSAnalytics_Google_Service_CivicInfo_SimpleAddressType';
  protected $normalizedInputDataType = '';
  protected $pollingLocationsType = 'WSAnalytics_Google_Service_CivicInfo_PollingLocation';
  protected $pollingLocationsDataType = 'array';
  protected $stateType = 'WSAnalytics_Google_Service_CivicInfo_AdministrationRegion';
  ...
  public function setElection(WSAnalytics_Google_Service_CivicInfo_Election $election)
  {
