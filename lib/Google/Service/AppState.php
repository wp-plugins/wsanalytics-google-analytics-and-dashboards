 ...
 * @author Google, Inc.
 */
class WSAnalytics_Google_Service_AppState extends WSAnalytics_Google_Service
{
  ...
  public function __construct(WSAnalytics_Google_Client $client)
  {
    ...
    $this->states = new WSAnalytics_Google_Service_AppState_States_Resource(
        $this,
        $this->serviceName,
        'states',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $appstateService = new WSAnalytics_Google_Service_AppState(...);
 *   $states = $appstateService->states;
 *  </code>
 */
class WSAnalytics_Google_Service_AppState_States_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * @return WSAnalytics_Google_Service_AppState_WriteResult
   */
  public function clear($stateKey, $optParams = array())
  {
    $params = array('stateKey' => $stateKey);
    $params = array_merge($params, $optParams);
    return $this->call('clear', array($params), "WSAnalytics_Google_Service_AppState_WriteResult");
  }
  /**
   ...
   * The key for the data to be retrieved.
   * @param array $optParams Optional parameters.
   * @return WSAnalytics_Google_Service_AppState_GetResponse
   */
  public function get($stateKey, $optParams = array())
  {
    $params = array('stateKey' => $stateKey);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WSAnalytics_Google_Service_AppState_GetResponse");
  }
  /**
   ...
   * @return WSAnalytics_Google_Service_AppState_ListResponse
   */
  public function listStates($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WSAnalytics_Google_Service_AppState_ListResponse");
  }
  /**
   ...
   * @param int $stateKey
   * The key for the data to be retrieved.
   * @param WSAnalytics_Google_UpdateRequest $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return WSAnalytics_Google_Service_AppState_WriteResult
   */
  public function update($stateKey, WSAnalytics_Google_Service_AppState_UpdateRequest $postBody, $optParams = array())
  {
    $params = array('stateKey' => $stateKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "WSAnalytics_Google_Service_AppState_WriteResult");
  }
}
...
class WSAnalytics_Google_Service_AppState_GetResponse extends WSAnalytics_Google_Model
{
...
class WSAnalytics_Google_Service_AppState_ListResponse extends WSAnalytics_Google_Collection
{
  protected $itemsType = 'WSAnalytics_Google_Service_AppState_GetResponse';
...
class WSAnalytics_Google_Service_AppState_UpdateRequest extends WSAnalytics_Google_Model
{
  public $data;
  public $kind;
...
class WSAnalytics_Google_Service_AppState_WriteResult extends WSAnalytics_Google_Model
{
  public $currentStateVersion;
  public $kind;
  public $stateKey;
