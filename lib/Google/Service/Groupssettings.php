 ...
 * @author Google, Inc.
 */
class WSAnalytics_Google_Service_Groupssettings extends WSAnalytics_Google_Service
{
  ...
  public function __construct(WSAnalytics_Google_Client $client)
  {
    ...
    $this->groups = new WSAnalytics_Google_Service_Groupssettings_Groups_Resource(
        $this,
        $this->serviceName,
        'groups',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $groupssettingsService = new WSAnalytics_Google_Service_Groupssettings(...);
 *   $groups = $groupssettingsService->groups;
 *  </code>
 */
class WSAnalytics_Google_Service_Groupssettings_Groups_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * @return WSAnalytics_Google_Service_Groupssettings_Groups
   */
  public function get($groupUniqueId, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WSAnalytics_Google_Service_Groupssettings_Groups");
  }
  /**
   ...
   * @param string $groupUniqueId
   * The resource ID
   * @param WSAnalytics_Google_Groups $postBody
   * @param array $optParams Optional parameters.
   * @return WSAnalytics_Google_Service_Groupssettings_Groups
   */
  public function patch($groupUniqueId, WSAnalytics_Google_Service_Groupssettings_Groups $postBody, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "WSAnalytics_Google_Service_Groupssettings_Groups");
  }
  /**
   ...
   * @return WSAnalytics_Google_Service_Groupssettings_Groups
   */
  public function update($groupUniqueId, WSAnalytics_Google_Service_Groupssettings_Groups $postBody, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "WSAnalytics_Google_Service_Groupssettings_Groups");
  }
}
...
class WSAnalytics_Google_Service_Groupssettings_Groups extends WSAnalytics_Google_Model
{
