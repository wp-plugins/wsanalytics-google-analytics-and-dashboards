 ...
 * @author Google, Inc.
 */
class WSAnalytics_Google_Service_Tasks extends WSAnalytics_Google_Service
{
  /** Manage your tasks. */
  ...
  public function __construct(WSAnalytics_Google_Client $client)
  {
    ...
    $this->tasklists = new WSAnalytics_Google_Service_Tasks_Tasklists_Resource(
        $this,
        $this->serviceName,
        'tasklists',
        array(
    ...
    $this->tasks = new WSAnalytics_Google_Service_Tasks_Tasks_Resource(
        $this,
        $this->serviceName,
        'tasks',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $tasksService = new WSAnalytics_Google_Service_Tasks(...);
 *   $tasklists = $tasksService->tasklists;
 *  </code>
 */
class WSAnalytics_Google_Service_Tasks_Tasklists_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * Task list identifier.
   * @param array $optParams Optional parameters.
   * @return WSAnalytics_Google_Service_Tasks_TaskList
   */
  public function get($tasklist, $optParams = array())
  {
    $params = array('tasklist' => $tasklist);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WSAnalytics_Google_Service_Tasks_TaskList");
  }
  /**
   * Creates a new task list and adds it to the authenticated user's task lists.
   * (tasklists.insert)
   *
   * @param WSAnalytics_Google_TaskList $postBody
   * @param array $optParams Optional parameters.
   * @return WSAnalytics_Google_Service_Tasks_TaskList
   */
  public function insert(WSAnalytics_Google_Service_Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "WSAnalytics_Google_Service_Tasks_TaskList");
  }
  /**
   ...
   * @return WSAnalytics_Google_Service_Tasks_TaskLists
   */
  public function listTasklists($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WSAnalytics_Google_Service_Tasks_TaskLists");
  }
  /**
   ...
   * @return WSAnalytics_Google_Service_Tasks_TaskList
   */
  public function patch($tasklist, WSAnalytics_Google_Service_Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "WSAnalytics_Google_Service_Tasks_TaskList");
  }
  /**
   ...
   * @return WSAnalytics_Google_Service_Tasks_TaskList
   */
  public function update($tasklist, WSAnalytics_Google_Service_Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "WSAnalytics_Google_Service_Tasks_TaskList");
  }
}
 ...
 *  </code>
 */
class WSAnalytics_Google_Service_Tasks_Tasks_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * Task identifier.
   * @param array $optParams Optional parameters.
   * @return WSAnalytics_Google_Service_Tasks_Task
   */
  public function get($tasklist, $task, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WSAnalytics_Google_Service_Tasks_Task");
  }
  /**
   ...
   * @param string $tasklist
   * Task list identifier.
   * @param WSAnalytics_Google_Task $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return WSAnalytics_Google_Service_Tasks_Task
   */
  public function insert($tasklist, WSAnalytics_Google_Service_Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "WSAnalytics_Google_Service_Tasks_Task");
  }
  /**
   ...
   * Lower bound for a task's due date (as a RFC 3339 timestamp) to filter by. Optional. The default
    * is not to filter by due date.
   * @return WSAnalytics_Google_Service_Tasks_Tasks
   */
  public function listTasks($tasklist, $optParams = array())
  {
    $params = array('tasklist' => $tasklist);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WSAnalytics_Google_Service_Tasks_Tasks");
  }
  /**
  ...
  public function move($tasklist, $task, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('move', array($params), "WSAnalytics_Google_Service_Tasks_Task");
  }
  /**
   ...
   * @return WSAnalytics_Google_Service_Tasks_Task
   */
  public function patch($tasklist, $task, WSAnalytics_Google_Service_Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "WSAnalytics_Google_Service_Tasks_Task");
  }
  /**
   ...
   * @return WSAnalytics_Google_Service_Tasks_Task
   */
  public function update($tasklist, $task, WSAnalytics_Google_Service_Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "WSAnalytics_Google_Service_Tasks_Task");
  }
}
...
class WSAnalytics_Google_Service_Tasks_Task extends WSAnalytics_Google_Collection
{
  public $completed;
  public $deleted;
  public $due;
  ...
  public $id;
  public $kind;
  protected $linksType = 'WSAnalytics_Google_Service_Tasks_TaskLinks';
...
class WSAnalytics_Google_Service_Tasks_TaskLinks extends WSAnalytics_Google_Model
{
  public $description;
  public $link;
  public $type;
...
class WSAnalytics_Google_Service_Tasks_TaskList extends WSAnalytics_Google_Model
{
  public $etag;
  public $id;
  public $kind;
...
class WSAnalytics_Google_Service_Tasks_TaskLists extends WSAnalytics_Google_Collection
{
  public $etag;
  protected $itemsType = 'WSAnalytics_Google_Service_Tasks_TaskList';
...
class WSAnalytics_Google_Service_Tasks_Tasks extends WSAnalytics_Google_Collection
{
  public $etag;
  protected $itemsType = 'WSAnalytics_Google_Service_Tasks_Task';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
