 ...
 * @author Google, Inc.
 */
class WSAnalytics_Google_Service_QPXExpress extends WSAnalytics_Google_Service
{
  ...
  public function __construct(WSAnalytics_Google_Client $client)
  {
    ...
    $this->trips = new WSAnalytics_Google_Service_QPXExpress_Trips_Resource(
        $this,
        $this->serviceName,
        'trips',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $qpxExpressService = new WSAnalytics_Google_Service_QPXExpress(...);
 *   $trips = $qpxExpressService->trips;
 *  </code>
 */
class WSAnalytics_Google_Service_QPXExpress_Trips_Resource extends WSAnalytics_Google_Service_Resource
{

  /**
   * Returns a list of flights. (trips.search)
   *
   * @param WSAnalytics_Google_TripsSearchRequest $postBody
   * @param array $optParams Optional parameters.
   * @return WSAnalytics_Google_Service_QPXExpress_TripsSearchResponse
   */
  public function search(WSAnalytics_Google_Service_QPXExpress_TripsSearchRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "WSAnalytics_Google_Service_QPXExpress_TripsSearchResponse");
  }
}
...
class WSAnalytics_Google_Service_QPXExpress_AircraftData extends WSAnalytics_Google_Model
{
  public $code;
  public $kind;
  public $name;
...
class WSAnalytics_Google_Service_QPXExpress_AirportData extends WSAnalytics_Google_Model
{
  public $city;
  public $code;
  public $kind;
...
class WSAnalytics_Google_Service_QPXExpress_BagDescriptor extends WSAnalytics_Google_Collection
{
...
class WSAnalytics_Google_Service_QPXExpress_CarrierData extends WSAnalytics_Google_Model
{
  public $code;
  public $kind;
  public $name;
...
class WSAnalytics_Google_Service_QPXExpress_CityData extends WSAnalytics_Google_Model
{
  public $code;
  public $country;
  public $kind;
...
class WSAnalytics_Google_Service_QPXExpress_Data extends WSAnalytics_Google_Collection
{
  protected $aircraftType = 'WSAnalytics_Google_Service_QPXExpress_AircraftData';
  protected $aircraftDataType = 'array';
  protected $airportType = 'WSAnalytics_Google_Service_QPXExpress_AirportData';
  protected $airportDataType = 'array';
  protected $carrierType = 'WSAnalytics_Google_Service_QPXExpress_CarrierData';
  protected $carrierDataType = 'array';
  protected $cityType = 'WSAnalytics_Google_Service_QPXExpress_CityData';
  protected $cityDataType = 'array';
  public $kind;
  protected $taxType = 'WSAnalytics_Google_Service_QPXExpress_TaxData';
...
class WSAnalytics_Google_Service_QPXExpress_FareInfo extends WSAnalytics_Google_Model
{
  public $basisCode;
  public $carrier;
  public $destination;
...
class WSAnalytics_Google_Service_QPXExpress_FlightInfo extends WSAnalytics_Google_Model
{
  public $carrier;
  public $number;
...
class WSAnalytics_Google_Service_QPXExpress_FreeBaggageAllowance extends WSAnalytics_Google_Collection
{
  protected $bagDescriptorType = 'WSAnalytics_Google_Service_QPXExpress_BagDescriptor';
...
class WSAnalytics_Google_Service_QPXExpress_LegInfo extends WSAnalytics_Google_Model
{
  public $aircraft;
  public $arrivalTime;
  public $changePlane;
...
class WSAnalytics_Google_Service_QPXExpress_PassengerCounts extends WSAnalytics_Google_Model
{
  public $adultCount;
  public $childCount;
...
class WSAnalytics_Google_Service_QPXExpress_PricingInfo extends WSAnalytics_Google_Collection
{
  public $baseFareTotal;
  protected $fareType = 'WSAnalytics_Google_Service_QPXExpress_FareInfo';
  protected $fareDataType = 'array';
  public $fareCalculation;
  public $kind;
  public $latestTicketingTime;
  protected $passengersType = 'WSAnalytics_Google_Service_QPXExpress_PassengerCounts';
  ...
  public $saleTaxTotal;
  public $saleTotal;
  protected $segmentPricingType = 'WSAnalytics_Google_Service_QPXExpress_SegmentPricing';
  protected $segmentPricingDataType = 'array';
  protected $taxType = 'WSAnalytics_Google_Service_QPXExpress_TaxInfo';
  protected $taxDataType = 'array';
  ...
  public function setPassengers(WSAnalytics_Google_Service_QPXExpress_PassengerCounts $passengers)
  {
...
class WSAnalytics_Google_Service_QPXExpress_SegmentInfo extends WSAnalytics_Google_Collection
{
  public $bookingCode;
  ...
  public $connectionDuration;
  public $duration;
  protected $flightType = 'WSAnalytics_Google_Service_QPXExpress_FlightInfo';
  protected $flightDataType = '';
  public $id;
  public $kind;
  protected $legType = 'WSAnalytics_Google_Service_QPXExpress_LegInfo';
  ...
  public function setFlight(WSAnalytics_Google_Service_QPXExpress_FlightInfo $flight)
  {
    $this->flight = $flight;
  }
...
class WSAnalytics_Google_Service_QPXExpress_SegmentPricing extends WSAnalytics_Google_Collection
{
  public $fareId;
  protected $freeBaggageOptionType = 'WSAnalytics_Google_Service_QPXExpress_FreeBaggageAllowance';
...
class WSAnalytics_Google_Service_QPXExpress_SliceInfo extends WSAnalytics_Google_Collection
{
  public $duration;
  public $kind;
  protected $segmentType = 'WSAnalytics_Google_Service_QPXExpress_SegmentInfo';
...
class WSAnalytics_Google_Service_QPXExpress_SliceInput extends WSAnalytics_Google_Collection
{
  public $alliance;
  public $date;
  public $destination;
  ...
  protected $permittedDepartureTimeType = 'WSAnalytics_Google_Service_QPXExpress_TimeOfDayRange';
  ...
  public function setPermittedDepartureTime(WSAnalytics_Google_Service_QPXExpress_TimeOfDayRange $permittedDepartureTime)
  {
...
class WSAnalytics_Google_Service_QPXExpress_TaxData extends WSAnalytics_Google_Model
{
  public $id;
  public $kind;
  public $name;
...
class WSAnalytics_Google_Service_QPXExpress_TaxInfo extends WSAnalytics_Google_Model
{
  public $chargeType;
  public $code;
  public $country;
...
class WSAnalytics_Google_Service_QPXExpress_TimeOfDayRange extends WSAnalytics_Google_Model
{
  public $earliestTime;
  public $kind;
  public $latestTime;
...
class WSAnalytics_Google_Service_QPXExpress_TripOption extends WSAnalytics_Google_Collection
{
  public $id;
  public $kind;
  protected $pricingType = 'WSAnalytics_Google_Service_QPXExpress_PricingInfo';
  protected $pricingDataType = 'array';
  public $saleTotal;
  protected $sliceType = 'WSAnalytics_Google_Service_QPXExpress_SliceInfo';
...
class WSAnalytics_Google_Service_QPXExpress_TripOptionsRequest extends WSAnalytics_Google_Collection
{
  public $maxPrice;
  protected $passengersType = 'WSAnalytics_Google_Service_QPXExpress_PassengerCounts';
  protected $passengersDataType = '';
  public $refundable;
  public $saleCountry;
  protected $sliceType = 'WSAnalytics_Google_Service_QPXExpress_SliceInput';
  protected $sliceDataType = 'array';
  public $solutions;
...
class WSAnalytics_Google_Service_QPXExpress_TripOptionsResponse extends WSAnalytics_Google_Collection
{
  protected $dataType = 'WSAnalytics_Google_Service_QPXExpress_Data';
  protected $dataDataType = '';
  public $kind;
  public $requestId;
  protected $tripOptionType = 'WSAnalytics_Google_Service_QPXExpress_TripOption';
  protected $tripOptionDataType = 'array';

  public function setData(WSAnalytics_Google_Service_QPXExpress_Data $data)
  {
    $this->data = $data;
  }
...
class WSAnalytics_Google_Service_QPXExpress_TripsSearchRequest extends WSAnalytics_Google_Model
{
  protected $requestType = 'WSAnalytics_Google_Service_QPXExpress_TripOptionsRequest';
  protected $requestDataType = '';

  public function setRequest(WSAnalytics_Google_Service_QPXExpress_TripOptionsRequest $request)
  {
...
class WSAnalytics_Google_Service_QPXExpress_TripsSearchResponse extends WSAnalytics_Google_Model
{
  public $kind;
  protected $tripsType = 'WSAnalytics_Google_Service_QPXExpress_TripOptionsResponse';
  ...
  public function setTrips(WSAnalytics_Google_Service_QPXExpress_TripOptionsResponse $trips)
  {
    $this->trips = $trips;
  }
