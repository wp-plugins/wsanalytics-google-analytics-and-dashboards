 ...
 * @author Google, Inc.
 */
class WSAnalytics_Google_Service_GamesManagement extends WSAnalytics_Google_Service
{
  ...
  public function __construct(WSAnalytics_Google_Client $client)
  {
    ...
    $this->achievements = new WSAnalytics_Google_Service_GamesManagement_Achievements_Resource(
        $this,
        $this->serviceName,
        'achievements',
        array(
    ...
    $this->applications = new WSAnalytics_Google_Service_GamesManagement_Applications_Resource(
        $this,
        $this->serviceName,
        'applications',
        array(
    ...
    $this->events = new WSAnalytics_Google_Service_GamesManagement_Events_Resource(
        $this,
        $this->serviceName,
        'events',
        array(
    ...
    $this->players = new WSAnalytics_Google_Service_GamesManagement_Players_Resource(
        $this,
        $this->serviceName,
        'players',
        array(
    ...
    $this->quests = new WSAnalytics_Google_Service_GamesManagement_Quests_Resource(
        $this,
        $this->serviceName,
        'quests',
        array(
    ...
    $this->rooms = new WSAnalytics_Google_Service_GamesManagement_Rooms_Resource(
        $this,
        $this->serviceName,
        'rooms',
        array(
    ...
    $this->scores = new WSAnalytics_Google_Service_GamesManagement_Scores_Resource(
        $this,
        $this->serviceName,
        'scores',
        array(
    ...
    $this->turnBasedMatches = new WSAnalytics_Google_Service_GamesManagement_TurnBasedMatches_Resource(
        $this,
        $this->serviceName,
        'turnBasedMatches',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $gamesManagementService = new WSAnalytics_Google_Service_GamesManagement(...);
 *   $achievements = $gamesManagementService->achievements;
 *  </code>
 */
class WSAnalytics_Google_Service_GamesManagement_Achievements_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * @return WSAnalytics_Google_Service_GamesManagement_AchievementResetResponse
   */
  public function reset($achievementId, $optParams = array())
  {
    $params = array('achievementId' => $achievementId);
    $params = array_merge($params, $optParams);
    return $this->call('reset', array($params), "WSAnalytics_Google_Service_GamesManagement_AchievementResetResponse");
  }
  /**
   ...
   *
   * @param array $optParams Optional parameters.
   * @return WSAnalytics_Google_Service_GamesManagement_AchievementResetAllResponse
   */
  public function resetAll($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('resetAll', array($params), "WSAnalytics_Google_Service_GamesManagement_AchievementResetAllResponse");
  }
  /**
 ...
 *  </code>
 */
class WSAnalytics_Google_Service_GamesManagement_Applications_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * The maximum number of player resources to return in the response, used for paging. For any
    ...
    * maxResults.
   * @return WSAnalytics_Google_Service_GamesManagement_HiddenPlayerList
   */
  public function listHidden($applicationId, $optParams = array())
  {
    $params = array('applicationId' => $applicationId);
    $params = array_merge($params, $optParams);
    return $this->call('listHidden', array($params), "WSAnalytics_Google_Service_GamesManagement_HiddenPlayerList");
  }
}
 ...
 *  </code>
 */
class WSAnalytics_Google_Service_GamesManagement_Events_Resource extends WSAnalytics_Google_Service_Resource
{
 ...
 *  </code>
 */
class WSAnalytics_Google_Service_GamesManagement_Players_Resource extends WSAnalytics_Google_Service_Resource
{
 ...
 *  </code>
 */
class WSAnalytics_Google_Service_GamesManagement_Quests_Resource extends WSAnalytics_Google_Service_Resource
{
 ...
 *  </code>
 */
class WSAnalytics_Google_Service_GamesManagement_Rooms_Resource extends WSAnalytics_Google_Service_Resource
{
 ...
 *  </code>
 */
class WSAnalytics_Google_Service_GamesManagement_Scores_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return WSAnalytics_Google_Service_GamesManagement_PlayerScoreResetResponse
   */
  public function reset($leaderboardId, $optParams = array())
  {
    $params = array('leaderboardId' => $leaderboardId);
    $params = array_merge($params, $optParams);
    return $this->call('reset', array($params), "WSAnalytics_Google_Service_GamesManagement_PlayerScoreResetResponse");
  }
  /**
 ...
 *  </code>
 */
class WSAnalytics_Google_Service_GamesManagement_TurnBasedMatches_Resource extends WSAnalytics_Google_Service_Resource
{
...
class WSAnalytics_Google_Service_GamesManagement_AchievementResetAllResponse extends WSAnalytics_Google_Collection
{
  public $kind;
  protected $resultsType = 'WSAnalytics_Google_Service_GamesManagement_AchievementResetResponse';
...
class WSAnalytics_Google_Service_GamesManagement_AchievementResetResponse extends WSAnalytics_Google_Model
{
  public $currentState;
  public $definitionId;
  public $kind;
...
class WSAnalytics_Google_Service_GamesManagement_GamesPlayedResource extends WSAnalytics_Google_Model
{
  public $autoMatched;
  public $timeMillis;
...
class WSAnalytics_Google_Service_GamesManagement_GamesPlayerExperienceInfoResource extends WSAnalytics_Google_Model
{
  public $currentExperiencePoints;
  protected $currentLevelType = 'WSAnalytics_Google_Service_GamesManagement_GamesPlayerLevelResource';
  protected $currentLevelDataType = '';
  public $lastLevelUpTimestampMillis;
  protected $nextLevelType = 'WSAnalytics_Google_Service_GamesManagement_GamesPlayerLevelResource';
  ...
  public function setCurrentLevel(WSAnalytics_Google_Service_GamesManagement_GamesPlayerLevelResource $currentLevel)
  {
  ...
  public function setNextLevel(WSAnalytics_Google_Service_GamesManagement_GamesPlayerLevelResource $nextLevel)
  {
...
class WSAnalytics_Google_Service_GamesManagement_GamesPlayerLevelResource extends WSAnalytics_Google_Model
{
  public $level;
...
class WSAnalytics_Google_Service_GamesManagement_HiddenPlayer extends WSAnalytics_Google_Model
{
  public $hiddenTimeMillis;
  public $kind;
  protected $playerType = 'WSAnalytics_Google_Service_GamesManagement_Player';
  ...
  public function setPlayer(WSAnalytics_Google_Service_GamesManagement_Player $player)
  {
    $this->player = $player;
  }
...
class WSAnalytics_Google_Service_GamesManagement_HiddenPlayerList extends WSAnalytics_Google_Collection
{
  protected $itemsType = 'WSAnalytics_Google_Service_GamesManagement_HiddenPlayer';
...
class WSAnalytics_Google_Service_GamesManagement_Player extends WSAnalytics_Google_Model
{
  public $avatarImageUrl;
  public $displayName;
  protected $experienceInfoType = 'WSAnalytics_Google_Service_GamesManagement_GamesPlayerExperienceInfoResource';
  protected $experienceInfoDataType = '';
  public $kind;
  protected $lastPlayedWithType = 'WSAnalytics_Google_Service_GamesManagement_GamesPlayedResource';
  protected $lastPlayedWithDataType = '';
  protected $nameType = 'WSAnalytics_Google_Service_GamesManagement_PlayerName';
  ...
  public function setExperienceInfo(WSAnalytics_Google_Service_GamesManagement_GamesPlayerExperienceInfoResource $experienceInfo)
  {
  ...
  public function setLastPlayedWith(WSAnalytics_Google_Service_GamesManagement_GamesPlayedResource $lastPlayedWith)
  {
  ...
  public function setName(WSAnalytics_Google_Service_GamesManagement_PlayerName $name)
  {
    $this->name = $name;
  }
...
class WSAnalytics_Google_Service_GamesManagement_PlayerName extends WSAnalytics_Google_Model
{
  public $familyName;
  public $givenName;
...
class WSAnalytics_Google_Service_GamesManagement_PlayerScoreResetResponse extends WSAnalytics_Google_Collection
{
  public $kind;
