 ...
 * @author Google, Inc.
 */
class WSAnalytics_Google_Service_Taskqueue extends WSAnalytics_Google_Service
{
  ...
  public function __construct(WSAnalytics_Google_Client $client)
  {
    ...
    $this->taskqueues = new WSAnalytics_Google_Service_Taskqueue_Taskqueues_Resource(
        $this,
        $this->serviceName,
        'taskqueues',
        array(
    ...
    $this->tasks = new WSAnalytics_Google_Service_Taskqueue_Tasks_Resource(
        $this,
        $this->serviceName,
        'tasks',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $taskqueueService = new WSAnalytics_Google_Service_Taskqueue(...);
 *   $taskqueues = $taskqueueService->taskqueues;
 *  </code>
 */
class WSAnalytics_Google_Service_Taskqueue_Taskqueues_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * @return WSAnalytics_Google_Service_Taskqueue_TaskQueue
   */
  public function get($project, $taskqueue, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WSAnalytics_Google_Service_Taskqueue_TaskQueue");
  }
}
 ...
 *  </code>
 */
class WSAnalytics_Google_Service_Taskqueue_Tasks_Resource extends WSAnalytics_Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return WSAnalytics_Google_Service_Taskqueue_Task
   */
  public function get($project, $taskqueue, $task, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "WSAnalytics_Google_Service_Taskqueue_Task");
  }
  /**
   ...
   * @return WSAnalytics_Google_Service_Taskqueue_Task
   */
  public function insert($project, $taskqueue, WSAnalytics_Google_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "WSAnalytics_Google_Service_Taskqueue_Task");
  }
  /**
   ...
   * @return WSAnalytics_Google_Service_Taskqueue_Tasks
   */
  public function lease($project, $taskqueue, $numTasks, $leaseSecs, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('lease', array($params), "WSAnalytics_Google_Service_Taskqueue_Tasks");
  }
  /**
   ...
   * @param array $optParams Optional parameters.
   * @return WSAnalytics_Google_Service_Taskqueue_Tasks2
   */
  public function listTasks($project, $taskqueue, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "WSAnalytics_Google_Service_Taskqueue_Tasks2");
  }
  /**
   ...
   * @return WSAnalytics_Google_Service_Taskqueue_Task
   */
  public function patch($project, $taskqueue, $task, $newLeaseSeconds, WSAnalytics_Google_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "WSAnalytics_Google_Service_Taskqueue_Task");
  }
  /**
   ...
   * @return WSAnalytics_Google_Service_Taskqueue_Task
   */
  public function update($project, $taskqueue, $task, $newLeaseSeconds, WSAnalytics_Google_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "WSAnalytics_Google_Service_Taskqueue_Task");
  }
}
...
class WSAnalytics_Google_Service_Taskqueue_Task extends WSAnalytics_Google_Model
{
...
class WSAnalytics_Google_Service_Taskqueue_TaskQueue extends WSAnalytics_Google_Model
{
  protected $aclType = 'WSAnalytics_Google_Service_Taskqueue_TaskQueueAcl';
  protected $aclDataType = '';
  public $id;
  public $kind;
  public $maxLeases;
  protected $statsType = 'WSAnalytics_Google_Service_Taskqueue_TaskQueueStats';
  protected $statsDataType = '';

  public function setAcl(WSAnalytics_Google_Service_Taskqueue_TaskQueueAcl $acl)
  {
    $this->acl = $acl;
  }
  ...
  public function setStats(WSAnalytics_Google_Service_Taskqueue_TaskQueueStats $stats)
  {
    $this->stats = $stats;
  }
...
class WSAnalytics_Google_Service_Taskqueue_TaskQueueAcl extends WSAnalytics_Google_Collection
{
  public $adminEmails;
...
class WSAnalytics_Google_Service_Taskqueue_TaskQueueStats extends WSAnalytics_Google_Model
{
...
class WSAnalytics_Google_Service_Taskqueue_Tasks extends WSAnalytics_Google_Collection
{
  protected $itemsType = 'WSAnalytics_Google_Service_Taskqueue_Task';
...
class WSAnalytics_Google_Service_Taskqueue_Tasks2 extends WSAnalytics_Google_Collection
{
  protected $itemsType = 'WSAnalytics_Google_Service_Taskqueue_Task';
  protected $itemsDataType = 'array';
  public $kind;
