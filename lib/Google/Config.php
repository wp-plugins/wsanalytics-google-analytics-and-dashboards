 ...
 */
class WSAnalytics_Google_Config
{
  ...
  /**
   * Create a new WSAnalytics_Google_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'WSAnalytics_Google_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'WSAnalytics_Google_Cache_File',
      ...
      'classes' => array(
        'WSAnalytics_Google_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'WSAnalytics_Google_Http_Request' => array(
        ...
        'WSAnalytics_Google_Auth_OAuth2' => array(
        ...
        'WSAnalytics_Google_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/WSAnalytics_Google_Client'
        )
      ),
